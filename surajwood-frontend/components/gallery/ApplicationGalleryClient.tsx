...
const APPLICATION_GALLERY_IMAGES: Record<string, GalleryItem[]> = {
  ...
  commercial: [
    ...
    },
    {
      ...
      caption: "Executive Conference Wall Panels — Charcoal Grey ACRYLUX",
      tag: "Office Space",
    },
    {
      src: "/images/gallery/commercial-3.jpg",
      caption: "Luxury Retail Showroom Display — Mirror Black ACRYGLASS",
      tag: "Retail Display",
    },
    {
      src: "/images/gallery/commercial-4.jpg",
      caption: "Premium Corporate Lobby Cladding — Ocean Teal ACRYLUX [Client Project]",
      tag: "Lobby Wall",
    },
    {
      src: "/images/gallery/20.jpg",
      caption: "Class B1 Fire-Safe Reception Console — Signal Red ACRYLUX",
      tag: "Reception Desk",
    },
    {
      src: "/images/gallery/21.jpg",
      caption: "Premium Corporate Executive Cabinets — Satin Grey ACRYSILK",
      tag: "Executive Cabinets",
    },
  ],
  offices: [
    {
