...
export default function ProductDetailClient({
  ...
  return (
    <>
      ...
      {/* 1. PRODUCT HERO                                                     */}
      {/* ------------------------------------------------------------------ */}
      <section className="relative min-h-screen lg:h-screen flex flex-col justify-between overflow-hidden bg-navy text-white">
        {/* Subtle decorative background gradient */}
        <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_top_right,_var(--tw-gradient-stops))] from-navy-light/35 via-navy to-navy pointer-events-none z-0" />

        {/* Spacer to clear sticky navbar (identical to Home, About, Applications) */}
        <div className="h-32 lg:h-40 shrink-0" />

        {/* Main Content Area: Centered in remaining space */}
        <div className="relative z-10 w-full max-w-7xl mx-auto px-6 md:px-12 flex-grow flex flex-col justify-center py-6">
          
          {/* High Contrast Breadcrumbs */}
          <nav aria-label="Breadcrumb" className="mb-6">
            <ol className="flex items-center gap-2 text-xs text-white/90 font-medium">
              <li>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-10 items-center">
            ...
            {/* Right: Bounded Interactive Product Image Container */}
            <div className="flex flex-col items-center">
              <div className="relative w-full max-w-sm xl:max-w-md aspect-[4/3] sm:aspect-square rounded-3xl overflow-hidden bg-white shadow-2xl flex items-center justify-center p-4 border border-white/10">
        ...
        {/* Subtle Bottom Accent (Matching Home/About/Application fold feel) */}
